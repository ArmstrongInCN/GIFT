...
- Frequency decomposition, the projections $P_{21}$/$Q_{21}$ and the coupled RK4 integration: [EXPERIMENTS.md](../EXPERIMENTS.md) sections 2.1 and 3.1.
...
- 频率分解、投影 $P_{21}$/$Q_{21}$ 与耦合 RK4 积分：[EXPERIMENTS.md](../EXPERIMENTS.md) 第 2.1、3.1 节。
