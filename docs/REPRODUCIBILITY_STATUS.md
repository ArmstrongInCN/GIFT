...
| New environment installation | Official cu126 wheel and all nine direct pins resolved successfully (32 packages). Actual installation interrupted by download timeout and Windows file-in-use error; not an installation pass |
