...
| Data generation controls | 17 bounded CPU tests passed; noise/sampling equivalence and clean integration schema checked. The later complete standard clean run is separate evidence below; other full clean datasets and training on a complete regenerated collection remain unverified |
