...
| Regenerated baseline input profile | Default released-file SHA retained; 29 bounded metadata/plumbing and rejection tests passed. Successful fixtures are not full generated-data acceptance; the later real standard-subcollection GIFT gates above are separately scoped and do not validate the FNO consumer |
