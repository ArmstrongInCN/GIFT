...
input data*, ScienceDB, DOI `10.57760/sciencedb.013lo` (CC BY 4.0). The same
fields can also be regenerated on your own device from the recorded
initial-condition parameters using the commands in [DATA_GENERATION.md](DATA_GENERATION.md),
so downloading this package is not required.
